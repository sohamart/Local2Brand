      ...
      >
        ...
        <div className={`max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 w-full transition-all duration-300 ${
          ...
          >
            ...
            >
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full overflow-hidden shadow-sm dark:shadow-[0_0_18px_rgba(168,85,247,0.5)] ring-2 ring-purple-500/30 dark:ring-purple-500/40 group-hover:scale-105 transition-transform shrink-0 border border-slate-200/80 dark:border-slate-700 bg-white dark:bg-slate-950 p-0.5 flex items-center justify-center relative">
                <img
                  src={activeLogoUrl}
                  alt={settings?.brandName || 'WEBLETS'}
                  className="w-full h-full object-contain object-center scale-110 transform-gpu"
                        ...
                        <div className="col-span-4 flex flex-col justify-between p-4 rounded-2xl bg-gradient-to-br from-purple-950/60 via-slate-900/80 to-slate-950 border border-purple-500/30 shadow-xl relative overflow-hidden group">
                          ...
                          <div className="relative z-10 space-y-3">
                            <div className="flex items-center justify-between">
                              <div className="w-10 h-10 rounded-full overflow-hidden bg-slate-950 border border-purple-400/40 p-0.5 flex items-center justify-center shadow-lg shadow-purple-500/20 group-hover:scale-105 transition-transform ring-2 ring-purple-500/30 shrink-0">
                                <img
                                  src={activeLogoUrl}
                                  alt={settings?.brandName || 'WEBLETS'}
                                  className="w-full h-full object-contain object-center scale-110 transform-gpu"
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          <div className="sticky top-0 left-0 right-0 z-50 bg-white/95 dark:bg-slate-950/95 backdrop-blur-2xl border-b border-slate-200/80 dark:border-slate-800/90 px-4 py-3 flex items-center justify-between shadow-xs shrink-0">
            ...
            >
              <div className="w-9 h-9 rounded-full overflow-hidden shadow-sm dark:shadow-[0_0_15px_rgba(168,85,247,0.4)] ring-2 ring-purple-500/30 dark:ring-purple-500/40 border border-slate-200/80 dark:border-slate-700 bg-white dark:bg-slate-950 p-0.5 flex items-center justify-center shrink-0">
                <img
                  src={activeLogoUrl}
                  alt={settings?.brandName || 'WEBLETS'}
                  className="w-full h-full object-contain object-center scale-110 transform-gpu"
