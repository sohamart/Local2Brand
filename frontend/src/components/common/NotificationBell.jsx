    ...
    <div className={`relative inline-block ${className}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <>
          ...
          {/* Popover Box (Fixed centered on mobile, absolute anchored on desktop) */}
          <div className="fixed left-3.5 right-3.5 top-16 sm:top-full sm:mt-2 sm:left-auto sm:right-0 sm:absolute w-auto sm:w-80 md:w-96 max-w-sm sm:max-w-none mx-auto sm:mx-0 rounded-3xl bg-white/95 dark:bg-[#0c1017]/95 backdrop-blur-2xl border border-slate-200 dark:border-slate-800 shadow-2xl z-50 p-4 sm:p-5 space-y-4 animate-in fade-in zoom-in-95 duration-200">
