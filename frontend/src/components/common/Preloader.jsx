    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center space-y-6 px-6">
        ...
        <div className="relative group">
          ...
          {/* Logo Container */}
          <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden shadow-2xl border-2 border-white/90 dark:border-slate-700 bg-white dark:bg-slate-900 p-0.5 animate-float">
            <img
              src="/logo.jpg"
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-center gap-2">
            <span className="font-extrabold text-2xl sm:text-3xl tracking-tight text-slate-900 dark:text-white leading-none">
              LOCAL<span className="l2b-gradient-text">2</span>BRAND
            </span>
            <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-bold bg-amber-50 dark:bg-amber-950/70 text-amber-900 dark:text-amber-300 border border-amber-200/80 dark:border-amber-500/40 shadow-2xs">
              <AshokaChakra size={11} />
              <span>IN</span>
            </span>
          </div>
          <p className="text-xs sm:text-sm font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest">
        ...
        <div className="w-56 sm:w-64 space-y-2 pt-2">
          <div className="h-1.5 w-full bg-slate-100 dark:bg-slate-900 rounded-full overflow-hidden border border-slate-200/80 dark:border-slate-800 p-0.5 shadow-inner">
            <div
          ...
          <div className="flex items-center justify-between text-[11px] font-mono font-bold text-slate-400 px-1">
            <span className="flex items-center gap-1 text-[10px] uppercase font-sans tracking-wider text-slate-500 dark:text-slate-400">
