  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 w-full relative">
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[500px] lg:min-h-[70vh]">
        ...
        <div className="relative w-full h-full liquid-glass-dark rounded-[3rem] border border-white/20 shadow-[0_40px_100px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col justify-center py-12 px-6 md:px-12 z-10">
          
          {/* Background Ambient Glow mapped to the current review - fast fade so it's not blank */}
