...
export default function ServicesOverview() {
  ...
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden">
      ...
      <div className="section-glow section-glow-purple top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[400px]" />
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {agencyServices.map((service, index) => {
            ...
            return (
              <div
                key={service.id}
                className={`glass-card p-7 sm:p-8 rounded-card border border-white/95 dark:border-slate-700/80 flex flex-col justify-between group relative ${
