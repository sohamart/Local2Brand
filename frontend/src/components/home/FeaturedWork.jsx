...
export default function FeaturedWork() {
  ...
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden">
      ...
      <div className="section-glow section-glow-blue top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[400px]" />
        ...
        <div className="mt-16 space-y-12">
          {displayedProjects.map((project, index) => {
            ...
            return (
              <div
                key={project.id}
                className="glass-panel rounded-hero p-5 sm:p-8 lg:p-10 border border-white dark:border-slate-700/80 shadow-glass transition-all duration-300 hover:shadow-glass-lg"
              >
