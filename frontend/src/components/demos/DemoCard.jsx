      ...
      <div className="relative aspect-[16/10] overflow-hidden bg-slate-100 dark:bg-slate-950">
        ...
        <div className="absolute top-3 left-3 right-3 flex items-center justify-between pointer-events-none">
          ...
          <div className="flex items-center gap-1.5 pointer-events-auto">
            {demo.badge && (
              <span className="px-2.5 py-1 rounded-full l2b-gradient-bg text-white text-[10px] font-bold shadow-xs flex items-center gap-1">
            ...
            <button
              ...
              className="w-7 h-7 rounded-full bg-white/90 dark:bg-slate-900/90 hover:bg-white text-slate-700 dark:text-slate-200 shadow-xs flex items-center justify-center transition-all cursor-pointer"
              title="Share Demo"
            >
        ...
        <div className="hidden sm:flex absolute inset-0 bg-slate-900/60 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-opacity duration-300 items-center justify-center gap-2 p-4">
          <Link
            to={`/demos/${demo.slug}`}
            className="px-3.5 py-2 rounded-xl bg-white dark:bg-slate-900 text-slate-900 dark:text-white font-bold text-xs shadow-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-all flex items-center gap-1"
          >
            <span>📱 Device Demo</span>
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3.5">
        ...
        <div className="pt-3 border-t border-slate-100 dark:border-slate-800 space-y-2.5">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link
              to={`/demos/${demo.slug}`}
              className="py-2.5 px-3 rounded-xl text-xs font-bold text-slate-800 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-center transition-all flex items-center justify-center gap-1"
            >
              <span>📱 Demo View</span>
            </Link>
