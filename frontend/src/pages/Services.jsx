          ...
          {servicesList.map((service, index) => {
            ...
            return (
              <div
                key={service.id}
                id={service.id}
                className="glass-panel rounded-hero p-6 sm:p-10 lg:p-14 border border-white dark:border-slate-700/80 shadow-floating relative overflow-hidden"
              >
                <div className={`grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center ${isReversed ? 'lg:flex-row-reverse' : ''}`}>
                  ...
                  <div className={`lg:col-span-6 space-y-6 ${isReversed ? 'lg:order-2' : ''}`}>
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-2xl bg-amber-50 dark:bg-amber-950/70 border border-amber-100 dark:border-amber-500/40 flex items-center justify-center text-amber-800 dark:text-amber-300 shadow-sm">
                    ...
                    <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                      <div>
                    ...
                    <div className="pt-2 flex flex-wrap items-center gap-4">
                      ...
                      <Link
                        to="/demos"
                        className="px-5 py-3 rounded-btn text-xs font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm"
                      >
                        View Demo Templates
                      </Link>
                    </div>
