            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
              ...
              <div className="space-y-3">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="flex items-center gap-1 text-xs text-amber-500 font-bold bg-white px-2 py-0.5 rounded-full border border-slate-200">
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col items-start sm:items-center lg:items-end justify-between gap-4 p-4 sm:p-5 rounded-2xl bg-white/90 border border-slate-200/80 shadow-sm shrink-0">
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  ...
                  <button
                    ...
                    className="p-3.5 rounded-xl text-emerald-800 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200/90 transition-all cursor-pointer"
              ...
              <div className="glass-panel p-6 sm:p-8 rounded-card border border-white shadow-floating space-y-6 sticky top-24">
                ...
                <div className="space-y-3 text-xs sm:text-sm">
                  <div className="flex justify-between py-1.5 border-b border-slate-100">
                    ...
                    <span className="font-bold text-slate-900">{demo.category}</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-b border-slate-100">
                    <span className="text-slate-500">Turnaround:</span>
                    <span className="font-bold text-emerald-600">{demo.turnaround}</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-b border-slate-100">
                    <span className="text-slate-500">Mobile Ready:</span>
                    <span className="font-bold text-slate-900">100% Tested</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-b border-slate-100">
                    <span className="text-slate-500">Core Web Vitals:</span>
                    <span className="font-bold text-purple-600">98+ PageSpeed</span>
                  </div>
                  <div className="flex justify-between py-1.5 border-b border-slate-100">
                    <span className="text-slate-500">Ownership:</span>
                    <span className="font-bold text-slate-900">100% Lifetime</span>
                  </div>
                </div>
