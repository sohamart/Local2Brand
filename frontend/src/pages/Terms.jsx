...
export default function Terms() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: `Clients represent and warrant that all materials, media, trademarks, text, and images provided to WEBLETS are lawfully owned or licensed by the client. The client agrees to indemnify and hold WEBLETS and its founders harmless from any copyright infringement, trademark disputes, or regulatory violations arising from client-submitted assets.`
    },
    {
      id: "uptime-liability",
      title: "7. Third-Party Services & Limitation of Liability",
      content: `While WEBLETS implements bank-grade security and sub-second performance architectures, we are not liable for outages, delays, or service disruptions caused by third-party infrastructure providers (including domain registrars, hosting servers like Vercel/AWS, payment gateways like Razorpay/Stripe, or external APIs). Under no circumstances shall WEBLETS's aggregate liability exceed the total project fee paid by the client.`
    },
    {
      id: "governing-law",
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 mt-2">
                Official terms of service governing projects and interactions on <span className="font-semibold text-purple-600 dark:text-purple-400">weblets.bond</span>.
              </p>
            </div>
