  ...
  return (
    <>
      ...
      <div className="min-h-[80vh] flex items-center justify-center px-4 pt-28 pb-16">
        <div className="glass-panel rounded-hero p-8 sm:p-14 border border-white shadow-floating text-center max-w-lg mx-auto">
          <div className="text-6xl sm:text-7xl font-black text-brand-600 font-mono mb-4">
            404
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              to="/demos"
              className="w-full sm:w-auto px-6 py-3 rounded-btn bg-white hover:bg-slate-50 border border-slate-200 text-slate-800 text-xs font-bold flex items-center justify-center gap-2 transition-all"
            >
