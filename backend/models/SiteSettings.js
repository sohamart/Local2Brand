...
const siteSettingsSchema = new mongoose.Schema(
  {
    ...
    aiSettings: {
      ...
      adminShowableDetails: {
        ...
        contactPhone: { type: String, default: '+91 87100 43923' },
        contactEmail: { type: String, default: 'contact@weblets.bond' },
        ...
        whatsappSupport: { type: String, default: '+91 87100 43923' },
        instagram: { type: String, default: 'https://instagram.com/local2brand' },
        instagramHandle: { type: String, default: '@local2brand' },
      },
    },
