...
const DEFAULT_SETTINGS = {
  ...
  appConfig: {
    enabled: true,
    appMode: 'pwa', // 'pwa' | 'apk' | 'coming_soon'
    isComingSoon: false,
    ...
    appSubtitle: 'Official Inbuilt Web App & Client Portal (Instant Home Screen Install)',
    appDescription: 'Install our fast inbuilt web app directly to your home screen. Monitor active website builds, communicate in real-time with your lead developer, track live milestones, and test responsive demo previews with 0 MB storage overhead.',
    version: 'v2.4.0 (PWA)',
